...
public class GetDataValues {
    ...
    public ArrayList<Year> getAllData(){
        return yearsList;
    }
    ...
    public LineData allTheYearsBarData() throws JSONException{
        //an array containing all the years in the dataset for this chart (1982-2012)
        int[] years = (int[]) parseData(empAgrJson)[0];
        ...
        for(int i=0; i<years.length;++i) {
            ...
            servComp.add(new Entry(serviceVals[i], i)); // 1 == quarter 2 ...
            indComp.add(new Entry(industryVals[i], i)); // 1 == quarter 2 ...
