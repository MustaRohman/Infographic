...
public class GetDataValues {
    ...
    public LineData LineGraphSectorData() throws JSONException {
        ...
        for (int i = 0; i < years.length; ++i) {
            //add the value to the array list for the year specified
            agriComp.add(new Entry(agricultureVals[i], ((years.length - 1) - i)));
            servComp.add(new Entry(serviceVals[i], ((years.length - 1) - i)));
            indComp.add(new Entry(industryVals[i], ((years.length - 1) - i)));
